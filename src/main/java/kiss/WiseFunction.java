...
public interface WiseFunction<Param, Return>
        extends Function<Param, Return>, Widen<WiseBiFunction, WiseFunction<Param, Return>>,
        Narrow<WiseSupplier<Return>, Param, WiseSupplier<Return>, Param, WiseFunction<Param, Return>> {

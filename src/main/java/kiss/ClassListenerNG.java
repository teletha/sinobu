 ...
 * </pre>
 * <p>
 * {@link ClassListenerNG} accepts not only so-called class (concreate class, abstract class and
 ...
 * </pre>
 * <p>
 * If you don't use any parameter, {@link ClassListenerNG} assumes that {@link Object} class is
 ...
 */
public interface ClassListenerNG<T> {
     ...
     */
    Disposable subscribe(Class<T> clazz, Disposable disposer);
}

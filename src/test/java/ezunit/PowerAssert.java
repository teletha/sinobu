...
public class PowerAssert extends ReusableRule {
    ...
    /**
     * @see ezunit.ReusableRule#validateError(java.lang.Throwable)
     */
    @Override
    ...
    private final class PowerAssertTranslator implements Translator {
        ...
        public void translate(ClassNode ast) {
            for (MethodNode methodNode : (List<MethodNode>) ast.methods) {
                ...
                context.add(new TypeInsnNode(NEW, "ezunit/PowerAssert$PowerAssertionContext"));
                context.add(new InsnNode(DUP));
                context.add(new MethodInsnNode(INVOKESPECIAL, "ezunit/PowerAssert$PowerAssertionContext", "<init>", "()V"));
                    ...
                    if (underAssertion) {
                        ...
                        if (node.getType() == AbstractInsnNode.TYPE_INSN) {
                            ...
                            if (type.getOpcode() == NEW && type.desc.equals("java/lang/AssertionError")) {
                                ...
                                // replace error
                                type.desc = "ezunit/PowerAssert$PowerAssertionError";

                                MethodInsnNode thrower = (MethodInsnNode) node.getNext().getNext();
                                thrower.owner = "ezunit/PowerAssert$PowerAssertionError";
                                thrower.desc = "(Lezunit/PowerAssert$PowerAssertionContext;)V";
    ...
    private static final class ContextBuilder {
        ...
        private static final String context = "ezunit/PowerAssert$PowerAssertionContext";

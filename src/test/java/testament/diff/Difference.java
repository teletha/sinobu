...
public class Difference {
    ...
    /**
     * The point at which the deletion ends, if any. A value equal to <code>NONE</code> means this
     * is an addition.
     */
    ...
    /**
     * Sets the point as deleted. The start and end points will be modified to include the given
     * line.
     */

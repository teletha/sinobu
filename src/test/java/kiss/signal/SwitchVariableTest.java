...
class SwitchVariableTest extends SignalTester {
    ...
    @Test
    void value() {
        monitor(Person.class, Integer.class, signal -> signal.switchVariable(v -> v.age));
    ...
    void rejectNull() {
        assertThrows(NullPointerException.class, () -> {
            monitor(() -> signal(1, 2).switchVariable((WiseFunction) null));
        });
    }
    ...
    void fromFinitToInfinit() {
        ...
        monitor(1, () -> I.signal(person).switchVariable(p -> p.age));
